...
export function CtaSection({ onGetStarted }: CtaSectionProps) {
  return (
    <section className="mx-auto w-full max-w-7xl px-5 py-20 md:px-8 md:py-24">
      <div className="rounded-2xl border border-[#E5E5E5] bg-gradient-to-br from-[#FACC15] via-[#FEF9C3] to-[#FFFFFF] p-8 text-center shadow-[0_20px_60px_rgba(250,204,21,0.16)] md:p-12">

      ...
      <div className="mx-auto w-full max-w-7xl px-4 py-16 sm:px-5 sm:py-20 md:px-8 md:py-24">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:mt-10 lg:grid-cols-4">
          {metrics.map((metric) => (
            <article
              key={metric.label}
              className="rounded-2xl border border-[#E7C74C] bg-white/72 p-5 shadow-[0_14px_36px_rgba(250,204,21,0.12)] backdrop-blur-sm sm:p-6"
            >
              <p className="text-sm text-[#525252]">{metric.label}</p>
              <p className="mt-2 text-3xl font-semibold tracking-tight text-[#A16207] sm:text-4xl">{metric.value}</p>

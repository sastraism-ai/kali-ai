...
const Waves: React.FC<WavesProps> = ({
  ...
  }, [lineColor, lineColors, waveSpeedX, waveSpeedY, waveAmpX, waveAmpY, friction, tension, maxCursorMove, xGap, yGap]);
  ...
  useEffect(() => {
    ...
    function drawLines() {
      ...
      ctx.beginPath();
      if (configRef.current.lineColors && configRef.current.lineColors.length > 0) {
        const gradient = ctx.createLinearGradient(0, 0, width, height);
        const stops = configRef.current.lineColors;
